...
public class MyDataSourceConfig implements DataSourceInfoConfig {
    ...
    public ConnectBean config() throws Exception {
        if(config == null){
            ...
            map.put("url","jdbc:mysql://xxxx:3306/firechildren?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true");
